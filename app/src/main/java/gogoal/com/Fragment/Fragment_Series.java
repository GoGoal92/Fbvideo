...
import gogoal.com.Adapter.Gripadapterseries;
import gogoal.com.Adapter.Main_recycler_adapter;
import gogoal.com.Adapter.Main_recycler_adapter2;
...
import static gogoal.com.Fragment.Fragment_Movies.list;
...
public class Fragment_Series extends Fragment {
    ...
    static Main_recycler_adapter2 adapter;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        list=new ArrayList<get>();
        adapter = new Main_recycler_adapter2(MainActivity.getactivity(), list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Myclient.getserieslist_refresh(Constant.apikey,"1");
            }
        });
        ...
        rv.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (pastVisibleItems + visibleItemCount >= totalItemCount) {
                    ...
                    Myclient.getserieslist(Constant.apikey,count + "");
                }
    ...
    public static void Feedback(String s) {
        ...
        if (status.equals("end")){
            ...
            list=new ArrayList<get>();
            list=Jsonparser.addMovielist_ser(s,list);
