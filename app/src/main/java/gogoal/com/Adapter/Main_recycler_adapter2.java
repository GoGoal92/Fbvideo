...
import gogoal.com.utils.HFRecyclerView;

/**
 * Created by Go Goal on 11/25/2016.
 */
public class Main_recycler_adapter2 extends HFRecyclerView<get> {
    ...
    public Main_recycler_adapter2(Activity getactivity, ArrayList<get> asklist1) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof HeaderViewHolder) {
            ...
            holder1.title.setText(Html.fromHtml(asklist.get(i-1).getMoviename()+"<br>Episode  ( "+asklist.get(i-1).getMoviepisode()+" )"));
            holder1.title.setTypeface(font);


            Picasso.with(ac) //
                    .load(Constant.host+"series/"+asklist.get(i-1).getMovieid()+".PNG")
                    .into(new Target() {
            ...
            holder1.rp.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
                ...
                public void onComplete(RippleView rippleView) {
                    ...
                    it.putExtra("a",asklist.get(i-1).getMovieid());
                    it.putExtra("filename",asklist.get(i-1).getMoviename()+" ( "+asklist.get(i-1).getMoviepisode()+" )");
                    ac.startActivity(it);
