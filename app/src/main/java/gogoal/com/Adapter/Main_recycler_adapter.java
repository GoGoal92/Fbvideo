 ...
 */
public class Main_recycler_adapter extends HFRecyclerView<get> {
    ...
    public Main_recycler_adapter(Activity getactivity, ArrayList<get> asklist1) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof HeaderViewHolder) {
            ...
            Picasso.with(ac) //
                    .load(Constant.host + "Movie/" + asklist.get(i-1).getMovieimgurl())
                    .into(new Target() {
                ...
                holder1.rp.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
                    ...
                    public void onComplete(RippleView rippleView) {
                        ...
                        it.putExtra("a", Constant.host + "/Movie/" + asklist.get(i-1).getMovieimgurl());
