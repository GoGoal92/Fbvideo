...
import gogoal.com.Adapter.Fragmentadapter_Main;
import gogoal.com.Adapter.Nlvadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remaintime =(LinearLayout) findViewById(R.id.remaintimeclick);
        ...
        remaintime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            //    LoginManager.getInstance().logInWithReadPermissions(ac, Arrays.asList("public_profile"));
